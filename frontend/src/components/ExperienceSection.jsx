					...
					<div className='flex items-start'>
						...
						<div>
							...
							<p className='text-gray-500 text-sm'>
								{formatDate(exp.startDate)} - {exp.endDate ? formatDate(exp.endDate) : "o momento"}
							</p>
				...
				<div className='mt-4'>
					...
					<div className='flex items-center mb-2'>
						<input
							...
							className='mr-2'
						/>
						<label htmlFor='currentlyWorking'>Trabalho atualmente neste cargo</label>
					</div>
